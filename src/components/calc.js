...
export const getCoordinates = (positions, glassesNumbers) => {
    ...
    let rel = Math.sqrt((positions[15].x - positions[35].x) * (positions[15].x - positions[35].x) +
            (positions[15].y - positions[35].y) * (positions[15].y - positions[35].y)) / Math.sqrt((positions[1].x - positions[35].x) * (positions[1].x - positions[35].x) +
    ...
    let wGlasses = (() => {
        return Math.sqrt((positions[16]._x - positions[0]._x) * (positions[16]._x - positions[0]._x)
            + (positions[16]._y - positions[0]._y) * (positions[16]._y - positions[0]._y));
    })();
    let hGlasses = (() => Math.sqrt(((positions[21]._y + positions[23]._y) / 2 - positions[32]._y) * ((positions[21]._y + positions[23]._y) / 2 -  positions[32]._y) +
        ...
        if (rel > 0.6 && rel < 1.666){
            ...
            case 0:
                if (Math.abs(angle) > 0.6) {
                    ...
                    rel = 0.6;
                    wGlasses /= 1.1;
                    xGl += angle > 0 ? wGlasses * 0.12 : wGlasses * 0.01;
                    hGlasses /= 1.1;
                    yGl -= angle > 0 ? hGlasses * 0.05 : -hGlasses * 0.03;
                }
            ...
            case 4:
                if (Math.abs(angle) > 0.6) {
                    ...
                    rel = 0.6;
                    wGlasses /= 1.1;
                    xGl += angle > 0 ? wGlasses * 0.09 : wGlasses * 0.01;
                    hGlasses /= 1.1;
            ...
            case 0:
                if (Math.abs(angle) > 0.6) {
                    ...
                    rel = 0.6;
                    xGl += angle > 0 ? wGlasses * 0.02 : wGlasses * 0.05;
                    yGl += -hGlasses * 0.2;
                }
                break;
            case 1:
            ...
            case 4:
                if (Math.abs(angle) > 0.6) {
                    rel = 0.6;
                    wGlasses /= 1.1;
                    xGl += angle > 0 ? wGlasses * 0.2 : wGlasses * 0.1;
                    hGlasses /= 1.1;
                    yGl += hGlasses * 0.05;
                }
                else if (Math.abs(angle) <= 0.6 && Math.abs(angle) > 0.4) {
            ...
            case 0:
                if (Math.abs(angle) > 0.6) {
                    ...
                    hGlasses /= 1.2;
                    yGl += angle > 0 ? -hGlasses * 0.15 : -hGlasses * 0.15;
                }
                else if (Math.abs(angle) <= 0.6 && Math.abs(angle) > 0.4) {
                    wGlasses /= 1.2;
            ...
            case 1:
                if (Math.abs(angle) > 0.6) {
                    ...
                    xGl += angle > 0 ? wGlasses * 0.08333333 * 2 : -wGlasses * 0.1;
                    hGlasses *= 1.2;
                    yGl += angle > 0 ? -hGlasses * 0.2 : -hGlasses * 0.25;
                }
                else if (Math.abs(angle) <= 0.6 && Math.abs(angle) > 0.4) {
                    wGlasses /= 1.2;
                    xGl += wGlasses * 0.08333333 * 2;
